<form class="form" method="post">
  ...
  <div class="form-group">
    <label>Title</label>
    <input type="text" name="page_title" value="{{ $oPage->title }}" class="form-validation" required>
  </div>

  <div class="form-group">
    <label>url slug</label>
    <input type="text" name="url_slug" value="{{ $oPage->slug }}" class="form-validation" required>
  </div>
